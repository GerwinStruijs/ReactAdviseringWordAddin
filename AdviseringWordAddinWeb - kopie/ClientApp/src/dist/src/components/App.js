...
var App = /** @class */ (function (_super) {
                    ...
                    case 0:
                        ...
                        return [4 /*yield*/, Word.run(function (context) { return __awaiter(_this, void 0, void 0, function () {
                                ...
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                            sentence = context.document.body.insertText("This is some formatted text!", "Replace");
                                            sentence.font.set({
                                                name: "Courier New",
                                                bold: true,
                                                size: 18
    ...
    App.prototype.render = function () {
        ...
        return (React.createElement("div", { className: "ms-welcome" },
            ...
            React.createElement(HeroList_1.default, { message: "Discover what Office .NET 8 Add-ins can do for you today!", items: this.state.listItems },
